function createEnemyList(){
    ...
    createEnemy(7, "Mimic", 1000, 100, 1, 1, "/images/enemies/pipo-enemy032.png", 50, 0, 0, [enemyWeapons[28], enemyWeapons[29], enemyWeapons[30], enemyWeapons[31]], 1250, 1250)
...
createZone(0, "The Inner Forest", [enemyList[0], enemyList[1], enemyList[2]])
createZone(1, "The Castle Walls", [enemyList[3], enemyList[4], enemyList[5]])
createZone(2, "The Dungeon Gate", [enemyList[6], enemyList[7], enemyList[8]])
createZone(3, "The Hall of Seto", [enemyList[9], enemyList[10], enemyList[11]])
createZone(4, "The Falling Hall", [enemyList[12], enemyList[13], enemyList[14]])
createZone(5, "The Final Breath", [enemyList[15]])
